...
static void sendMTFValues(EState *s) {
...

  {
        ...
        if (s->verbosity >= 3) {
          {
            fprintf((FILE * /* __restrict  */) stderr,
                    (char const
                         * /* __restrict  */) "      initial group %d, [%d .. "
                                              "%d], has %d syms (%4.1f%%)\n",
                    nPart, gs, ge, aFreq,
                    (100.0 * (double)((float)aFreq)) /
                        (double)((float)s->nMTF));
          }
        }
        v = 0;
    ...
    if (s->verbosity >= 3) {
      {
        fprintf((FILE * /* __restrict  */) stderr,
                (char const * /* __restrict  */) "selectors %d, ",
                s->numZ - nBytes);
      }
    }
    nBytes = s->numZ;
      ...
      if (s->verbosity >= 2) {
        {
          fprintf(
              (FILE * /* __restrict  */) stderr,
              (char const
                   * /* __restrict  */) "    block %d: crc = 0x%08x, combined "
                                        "CRC = 0x%08x, size = %d\n",
      ...
      if (s->verbosity >= 2) {
        {
          fprintf(
              (FILE * /* __restrict  */) stderr,
              (char const
                   * /* __restrict  */) "    final combined CRC = 0x%08x\n   ",
              s->combinedCRC);
        }
      }
      { bsFinishWrite(s); }
...
static Bool testStream(FILE *zStream) {
  ...
  errhandler : { BZ2_bzReadClose(&bzerr_dummy, bzf); }
    ...
    case_neg_4 : /* CIL Label */
    {
      fprintf((FILE * /* __restrict  */) stderr,
              (char const
                   * /* __restrict  */) "data integrity (CRC) error in data\n");
    }
      return ((Bool)0);
    case_neg_3 : /* CIL Label */
    {
    ...
    case_neg_5: /* CIL Label */
      ...
      if (streamNo == 1) {
        {
          fprintf((FILE * /* __restrict  */) stderr,
                  (char const * /* __restrict  */) "bad magic number (file not "
                                                   "created by bzip2)\n");
        }
        return ((Bool)0);
      } else {
        if (noisy) {
          {
            fprintf((FILE * /* __restrict  */) stderr,
                    (char const * /* __restrict  */) "trailing garbage after "
                                                     "EOF ignored\n");
          }
        }
        return ((Bool)1);
